...
namespace TechnitiumLibrary.UnitTests.TechnitiumLibrary.Net
{
    ...
    public sealed class EndPointExtensionsTests
    {
        ...
        public async Task GetIPEndPointAsync_ShouldFallback_WhenRequestedFamilyUnsupported()
        {
            ...
            Assert.IsInstanceOfType<IPEndPoint>(ep, "Returned endpoint must still be resolved.");
        }
        ...
        public void GetEndPoint_ShouldReturn_IPEndpoint_OnLiteralIP()
        {
            ...
            Assert.IsInstanceOfType<IPEndPoint>(ep, "Literal IP input must produce IPEndPoint.");
        }
        ...
        public void TryParse_ShouldReturnTrue_ForIPEndPointSyntax()
        {
            ...
            Assert.IsInstanceOfType<IPEndPoint>(ep);
        }
        ...
        [TestMethod]
        public void TryParse_ShouldSetPort0_WhenMissingPort()
        {
            bool ok = EndPointExtensions.TryParse("example.com", out EndPoint? ep);
            Assert.IsTrue(ok, "Missing port must parse successfully.");
            Assert.AreEqual(0, ep.GetPort());
        }
