...
namespace TechnitiumLibrary.UnitTests.TechnitiumLibrary.Net.Proxy
{
    ...
    public sealed class NetProxyBypassItemTests
    {
        ...
        {
            NetProxyBypassItem bypass = new NetProxyBypassItem("192.168.1.0/24");
            IPEndPoint ep = new IPEndPoint(IPAddress.Parse("192.168.1.42"), 80);
        ...
        {
            NetProxyBypassItem bypass = new NetProxyBypassItem("192.168.1.0/24");
            IPEndPoint ep = new IPEndPoint(IPAddress.Parse("192.168.2.1"), 80);
        ...
        {
            NetProxyBypassItem bypass = new NetProxyBypassItem("10.0.0.5");
        ...
        {
            NetProxyBypassItem bypass = new NetProxyBypassItem("fe80::/10");
            IPEndPoint ep = new IPEndPoint(IPAddress.Parse("fe80::1"), 443);
        ...
        {
            NetProxyBypassItem bypass = new NetProxyBypassItem("localhost");
        ...
        public void IsMatching_Localhost_DoesNotMatchDnsEndPoint()
        {
            ...
            DnsEndPoint ep = new DnsEndPoint("localhost", 80);
        ...
        public void IsMatching_Hostname_DoesNotMatchDifferentName()
        {
            ...
            DnsEndPoint ep = new DnsEndPoint("example.com", 80);
        ...
        {
            NetProxyBypassItem bypass = new NetProxyBypassItem("127.0.0.1");
        ...
        {
            NetProxyBypassItem bypass = new NetProxyBypassItem("192.168.0.0/16");
            IPEndPoint ep = new IPEndPoint(IPAddress.Parse("192.168.10.10"), 80);
